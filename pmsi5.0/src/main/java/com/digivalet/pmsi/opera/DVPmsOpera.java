...
public class DVPmsOpera extends DVPms implements DVPmsEventNotifier
{
   ...
   private DVPmsConnectionManager connectionManager;
   ...
   private void init()
   {
      ...
      {
         connectionManager =
                  new DVPmsConnectionManager(dvSettings, this, dvPmsDatabase);
            ...
            String targetDeviceId)
   {
      try
      {
         ...
         dvPmsDatabase.insertRemoteCheckoutGuestId(targetDeviceId, roomId,
                  guestId);
