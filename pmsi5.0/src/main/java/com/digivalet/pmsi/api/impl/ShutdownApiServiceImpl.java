...
@javax.annotation.Generated(
         ...
         date = "2017-12-14T23:29:50.546Z")
public class ShutdownApiServiceImpl extends ShutdownApiService
{
   static DVLogger dvLogger = DVLogger.getInstance();

   @Override
   public Response shutdown(String accessToken, @NotNull String hotelCode,
            SecurityContext securityContext) throws NotFoundException
   {

      JSONObject tokenVerify = null;
      dvLogger.info(" Inside shutdown PMSI");
      Thread.currentThread().setName("SHUTDOWN-API");
      try
      {
      ...
      if (valid.getCode() == DVResult.SUCCESS)
      {
         try
         {
            DVPmsMain.getInstance().getDvPmsController().shutDownPms();
         ...
         {
            dvLogger.error("Error in getting shutdwon pms ", e);
         }
